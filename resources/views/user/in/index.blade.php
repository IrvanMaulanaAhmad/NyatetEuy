...
@section('content')
	<div class="row">
		...
		<div class="col-xl-4 col-lg-4 col-md-6 col-sm-12 col-xs-12">
			<div class="card">
				<div class="card-body">
					<p>Total Transaction In : {{ $trtotal }} time(s)</p>
				</div>
			</div>
		</div>
		<div class="col-xl-4 col-lg-4 col-md-6 col-sm-12 col-xs-12">
			...
			<div class="card">
				<div class="card-body">
					<table class="table table-hover">
						<thead>
							<tr>
								<th style="text-align: right" colspan="5"><a href="{{ route('user.trin.create') }}" class="btn btn-primary"> Add Transaction In</a></th>
							</tr>
							<tr>
								<th>No</th>
								<th>Title</th>
						...
						<tbody>
							...
							@endphp
								<tr>
									...
									<td>
										<div class="btn-group">
											<a href="{{ route('user.trin.edit', $trin->id) }}" class="btn btn-sm btn-success" data-toggle="tooltip" data-placement="top" title="Edit" id="edit" aria-hidden="true">
												<i class="fa fa-pencil"></i>
											</a>
											<form action="{{ route('user.trin.delete', $trin->id) }}" method="post">
												@csrf
												@method('delete')
